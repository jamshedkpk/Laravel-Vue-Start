    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="single-discount-product mt-30">
                    <div class="product-image">
                        <img src="{{ asset('user_template/assets/images/discount-product/product-1.jpg') }}" alt="Product">
                    </div> <!-- product image -->
            ...
            <div class="col-lg-6">
                <div class="single-discount-product mt-30">
                    <div class="product-image">
                        <img src="{{ asset('user_template/assets/images/discount-product/product-2.jpg') }}" alt="Product">
                    </div> <!-- product image -->
                    <div class="product-content">
