    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    <div class="team-image">
                        <img src="{{ asset('user_template/assets/images/team/t-1.jpg') }}"
                         alt="Team">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    <div class="team-image">
                        <img src="{{ asset('user_template/assets/images/team/t-2.jpg') }}"
                         alt="Team">
                    </div>
                    <div class="team-content mt-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    <div class="team-image">
                        <img src="{{ asset('user_template/assets/images/team/t-3.jpg') }}"
                         alt="Team">
                    </div>
                    <div class="team-content mt-30">
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="single-temp text-center mt-30">
                    <div class="team-image">
                        <img src="{{ asset('user_template/assets/images/team/t-4.jpg') }}"
                         alt="Team">
                    </div>
                    <div class="team-content mt-30">
